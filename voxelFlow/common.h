...
#define SRC_FREQ		REC_MAX_FREQ //1500000000
...
//#define CUTOFF_FREQ		(CT/DELTA_LENGTH/4)
//#define REC_MAX_FREQ	(CT/DELTA_LENGTH/10)
//#define DELTA_LENGTH	0.5
//#define SRC_FREQ		10 //1500000000

#define WALL_DEC_PCM	0.3 // per 10cm thickness
#define WALL_DEC		WALL_DEC_PCM

#define SAMPLES_TO_AVERAGE (5 * 20) //(5*CT/SRC_FREQ) //(5*CT/REC_MAX_FREQ) //200
#define SAMPLING 50 //(CT/SRC_FREQ) //(1*CT/REC_MAX_FREQ) //20
